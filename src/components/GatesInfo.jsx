...
const GatesInfo = ({ inspectedGate, onCloseLore }) => {
    return (
        <div className="fixed sm:absolute z-[99999] bottom-6 left-6 right-6 sm:bottom-auto sm:left-auto sm:top-6 sm:right-6">
            ...
            {!inspectedGate ? (
                ...
                <div className="pointer-events-auto bg-[#25A7E2] max-w-md border-4 border-black rounded-xl p-5 transition-all duration-200 animate-in fade-in zoom-in-90">
                    ...
                    <div className="flex items-center justify-between pb-3 mb-3 border-b-4 border-black/15">
                        <span className="font-black text-black text-xs uppercase tracking-widest px-2 py-0.5 bg-white border-2 border-black rounded bg-[#FFD900]">
                    ...
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h4 className="font-black text-2xl leading-none text-black tracking-tight">{inspectedGate.name}-Gate</h4>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-1.5 mb-1 border-t-4 border-black/15 mt-3 pt-3 font-black tracking-tight text-black bg-[#FFD900] border-2 border-black rounded-xl p-3 shadow-[2px_2px_0px_0px_#000]">
