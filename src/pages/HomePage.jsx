...
export default function Homepage() {
    ...
    return (
        ...
        >
            <div class="fixed inset-0 bg-black/15 bottom-0 "></div>

            <nav className="w-full max-w-350 mx-auto flex justify-between items-center mb-12 sm:mb-16 relative z-50">

                <div className="bg-yellow-300 rounded-3xl px-6 py-2 cursor-pointer transition-all duration-150 shadow-[0_4px_0_0_#B8860B,0_6px_0_0_#0f172a] hover:-translate-y-1 hover:scale(1.5)">
            ...
            <div className="flex-1 w-full max-w-350 mx-auto relative flex flex-col justify-center items-center text-center z-10 mb-20">
                ...
                >
                    ...
                    <div className="relative z-20 py-10 px-6 sm:py-3 sm:px-12 max-w-4xl mx-auto flex flex-col items-center">
                        ...
                        <p className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900 mb-10 max-w-2xl leading-relaxed bg-white/80 p-6 rounded-3xl border-2 border-slate-900 shadow-[4px_4px_0px_0px_#0f172a] backdrop-blur-sm">
                ...
                >
                    <span className="font-black text-white text-5xl font-['Fredoka',sans-serif] drop-shadow-md">H</span>
                </motion.div>
                ...
                >
                    <span className="font-black text-white text-5xl font-['Fredoka',sans-serif] drop-shadow-md">Y</span>
                </motion.div>
            </div>
            ...
            <section id="blogsSection" className="w-full max-w-350 mx-auto relative z-20 mb-12 mt-12">
                <motion.img
                    ...
                    src="https://cdn3d.iconscout.com/3d/premium/thumb/astronaut-jumping-space-3d-icon-png-download-10994278.png"
                    alt="Mascot Standing"
                ...
                <div className="flex justify-between items-end mb-8">
                    ...
                    <a href="/blogs" className="text-slate-900 bg-[#FFD93D] font-black uppercase tracking-wider px-6 py-3 rounded-xl transition-all duration-150 shadow-[0_4px_0_0_#B8860B,0_6px_0_0_#0f172a] hover:-translate-y-1 hover:shadow-[0_6px_0_0_#B8860B,0_8px_0_0_#0f172a] active:translate-y-1 active:shadow-[0_0px_0_0_#B8860B,0_0px_0_0_#0f172a]">
                        Read All
                    </a>
                </div>
                    ...
                    {blogs.map((blog, i) => (
                        ...
                        >
                            <div>
                                ...
                                <h3 className="text-3xl font-black text-white leading-tight font-['Fredoka',sans-serif] drop-shadow-lg mb-4">
                                    {blog.title}
                                </h3>
            ...
            <footer className="w-full max-w-350 mx-auto relative z-20 mb-8">
                <div className="bg-teal-800 backdrop:backdrop-blur-2xl rounded-4xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[12px_12px_0px_0px_#0f172a]">
                    <div>
                        <h3 className="text-3xl font-black text-white font-['Fredoka',sans-serif] mb-2">For Interactions</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-slate-900 bg-[#FFD93D] font-black uppercase tracking-wider px-6 py-3 rounded-xl border-4 border-slate-900 transition-all duration-150 shadow-[0_4px_0_0_#B8860B,0_6px_0_0_#0f172a] hover:-translate-y-1 hover:shadow-[0_6px_0_0_#B8860B,0_8px_0_0_#0f172a] active:translate-y-1 active:shadow-[0_0px_0_0_#B8860B,0_0px_0_0_#0f172a]">
                            Instagram
                        </a>
